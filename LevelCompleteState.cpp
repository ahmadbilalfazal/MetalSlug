...
void LevelCompleteState::Enter() {
    background = LoadTexture("assets/menu/background.png");
    completeTexture = LoadTexture(isGameComplete ? "assets/ui/game_complete.png" : "assets/ui/level_complete.png");
    completeSound = LoadSound("assets/sounds/level_complete.wav");
